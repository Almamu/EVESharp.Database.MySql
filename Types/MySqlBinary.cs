...
#region IMySqlValue Members
    ...
    object IMySqlValue.Value => this._mValue;

    public byte [] Value => this._mValue;
    ...
    IMySqlValue IMySqlValue.ReadValue (MySqlPacket packet, long length, bool nullVal)
    {
        ...
        if (nullVal)
        {
            b = new MySqlBinary (this._type, true);
        }
        else
        {
            if (length == -1)
            ...
            b = new MySqlBinary (this._type, newBuff);
        }
    ...
    public static void SetDSInfo (MySqlSchemaCollection sc)
    {
        ...
        {
            MySqlDbType.Blob, MySqlDbType.TinyBlob, MySqlDbType.MediumBlob, MySqlDbType.LongBlob, MySqlDbType.Binary, MySqlDbType.VarBinary
        };
