...
#region IServiceProvider Members
    ...
    private Type DbServicesType =>
        this._dbServicesType ?? (this._dbServicesType = Type.GetType (
    ...
    private FieldInfo MySqlDbProviderServicesInstance
    {
        get
        {
            if (this._mySqlDbProviderServicesInstance == null)
            {
                ...
                this._mySqlDbProviderServicesInstance = providerServicesType.GetField (
    ...
    object IServiceProvider.GetService (Type serviceType)
    {
        ...
        return serviceType != this.DbServicesType ? null : this.MySqlDbProviderServicesInstance?.GetValue (null);
    }
