...
#region Public Methods
    ...
    public static void DeriveParameters (MySqlCommand command)
    {
        ...
        try
        {
            ...
            foreach (MySqlSchemaRow row in entry.parameters.Rows)
            {
                ...
                p.MySqlDbType = MetaData.NameToType (
    ...
    {
        return (MySqlCommand) this.GetInsertCommand (false);
    }
    ...
    public override string QuoteIdentifier (string unquotedIdentifier)
    {
        ...
        if (unquotedIdentifier.StartsWith (this.QuotePrefix) &&
            unquotedIdentifier.EndsWith (this.QuoteSuffix))
    ...
    public override string UnquoteIdentifier (string quotedIdentifier)
    {
        ...
        if (!quotedIdentifier.StartsWith (this.QuotePrefix) ||
            !quotedIdentifier.EndsWith (this.QuoteSuffix))
    ...
    (
        DbParameter   parameter,     DataRow row,
    ...
    protected override void SetRowUpdatingHandler (DbDataAdapter adapter)
    {
        ...
        if (adapter != base.DataAdapter)
            myAdapter.RowUpdating += new MySqlRowUpdatingEventHandler (this.RowUpdating);
        else
            myAdapter.RowUpdating -= new MySqlRowUpdatingEventHandler (this.RowUpdating);
    }
